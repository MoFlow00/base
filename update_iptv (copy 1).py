                ...
                if len(inputs) >= 3:
                    ...
                    if os.path.exists(base_file):
                        ...
                        try:
                            ...
                            if "nothing to commit" in (commit_status.stdout + commit_status.stderr).lower() or "no changes added to commit" in (commit_status.stdout + commit_status.stderr).lower():
                        ...
                        raise Exception("base.m3u missing at /root/base/base.m3u")
